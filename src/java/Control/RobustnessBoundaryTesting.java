 ...
 * @author tanle
 */
public class RobustnessBoundaryTesting {

    public RobustnessBoundaryTesting() {
    }
    ...
    public ArrayList<TriangleClassify> generateTestCasesForTriangleProblem (int min, int max){
        ...
        int nom = (min+max)/2;
        int[] table = {min-1, min, min+1, max-1, max, max+1};
    ...
    public ArrayList<CommissionTestcases> generateTestCasesForCommissionProblem(Lock lock, Stock stock, Barrel barrel) {
        ...
        int[] lockTable = {lockMin-1, lockMin, lockMin+1, lockMax-1, lockMax, lockMax+1};
        int[] stockTable = {stockMin-1, stockMin, stockMin+1, stockMax-1, stockMax, stockMax+1};
        int[] barrelTable = {barrelMin-1, barrelMin, barrelMin+1, barrelMax-1, barrelMax, barrelMax+1};
